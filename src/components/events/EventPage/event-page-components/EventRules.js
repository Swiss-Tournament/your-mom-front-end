...
const EventRules = (props, status) => {
  ...
  return (
    <RulesWrapper>
      ...
      <DataWrapper>
        <Paragraph>
          <h3>Format:</h3> {eventFormat.format}
        </Paragraph>
        <Paragraph>
          <h3>Legal Sets:</h3> {eventFormat.sets}
        </Paragraph>
        <Paragraph>
          <h3>Banned/Restricted Cards:</h3> {eventFormat.banned}
        </Paragraph>
        <Paragraph>
          <h3>Deck Construction Rules:</h3> {eventFormat.deckRules}
        </Paragraph>
      </DataWrapper>
    </RulesWrapper>
  );
